...
import (
	"github.com/gabrielbabler/fullcycle-e-commerce/internal/database"
...
func (ps *ProductService) CreateNewProduct(name, description, category_id, image_url string, price float64) (*entity.Product, error) {
