...
import (
	...
	"github.com/gabrielbabler/fullcycle-e-commerce/internal/entity"
	"github.com/gabrielbabler/fullcycle-e-commerce/internal/service"
...
func (wph *WebProductHandler) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	result, err := wph.ProductService.CreateNewProduct(product.Name, product.Description, product.CategoryID, product.ImageURL, product.Price)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
